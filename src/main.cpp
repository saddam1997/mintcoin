...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Feb 2, 2014:  on the board with a touchdown in the final seconds of the third quarter. But the Seattle Seahawks are dominating the Broncos 36-8";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("600e575b74bc693358e3e07d18006df7ca342cc970f26a9522e3c276c0a28da4"));
